...
local awesomeconf = home .. "/.config/awesome"
-- }}}

-- {{{ Variable definitions
-- Themes define colours, icons, font and wallpapers.
beautiful.init(awesomeconf .. "/theme.lua")

-- This is used later as the default terminal and editor to run.
terminal = "/usr/bin/terminator" or "xterm"
editor = "/usr/bin/vim" or "vi"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    local t_layouts = { l.tile, l.tile, l.tile, l.tile, l.tile }
    awful.tag(t_names, s, t_layouts)
